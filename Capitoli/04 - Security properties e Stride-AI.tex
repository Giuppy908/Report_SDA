...
Tali categorie non sono quindi direttamente applicabili all'architettura
attuale, ma diventerebbero rilevanti in presenza di autonomia, tool calling,
memoria persistente o interazione diretta dei modelli con servizi esterni.