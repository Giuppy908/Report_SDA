...
Per evitare valutazioni ridondanti, alcuni failure mode che soddisfano i criteri precedenti non vengono analizzati separatamente quando risultano fortemente sovrapposti ad altre minacce già selezionate. In particolare, FM13.4 non viene valutato tramite DREAD poiché presenta modalità di compromissione ed effetti largamente sovrapponibili a quelli di FM13.1, già considerato come scenario rappresentativo per l'asset A13.
